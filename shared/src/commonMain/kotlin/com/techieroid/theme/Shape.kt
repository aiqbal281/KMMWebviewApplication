...
fun DefaultNavigationBarItemTheme() = NavigationBarItemDefaults.colors(
    selectedIconColor = Color.White.copy(1f),
    unselectedIconColor = Color.White.copy(.6f),
    unselectedTextColor = Color.White.copy(.6f),
    selectedTextColor = Color.White.copy(1f),
    indicatorColor = splashBackground,
)
